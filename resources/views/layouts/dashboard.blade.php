...
<body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="{{ route('home') }}">CarRental3 - Laravel</a>
          ...
          <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="sidebar-sticky pt-3">
              <ul class="nav flex-column">
                <li class="nav-item mt-2 border-0 rounded shadow ">
                ...
                <li class="nav-item mt-2 border-0 rounded shadow ">
                  <a class="nav-link" href="{{route('rent-price.index')}}">
                ...
                <li class="nav-item mt-2 border-0 rounded shadow ">
                  <a class="nav-link" href="{{ route('stats-management.index') }}">
